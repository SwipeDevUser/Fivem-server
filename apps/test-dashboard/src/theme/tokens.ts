 ...
 * Production-grade token system for FiveM Dashboard
 */
...
export const tokens = {
  ...
  colors: {
    ...
    text: {
      primary: '#f1f5f9', // slate-100 (97% contrast on dark bg)
      secondary: '#cbd5e1', // slate-300 (80% contrast)
      tertiary: '#94a3b8', // slate-400 (70% contrast)
  ...
  shadows: {
    ...
    elevation: '0 25px 50px -12px rgb(0 0 0 / 0.5)',
  },
