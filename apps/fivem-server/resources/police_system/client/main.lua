...
RegisterNetEvent('police:cuff', function()
    ...
    TaskPlayAnim(ped, Config.CuffAnimations.dict, Config.CuffAnimations.anim, 8.0, -8.0, -1, 1, 0, false, false, false)
...
RegisterKeyMapping('closepoliceui', 'Close Police UI', 'keyboard', 'escape')
RegisterCommand('closepoliceui', function()
    SendNUIMessage({
        show = false,
    })
